...
namespace HeathenEngineering.SteamApi.Networking
{
    ...
    public class HeathenSteamP2PTransport : Transport
    {
        ...
        /// <summary>
        /// Internal class defining a specific CSteamID conneciton and its state
        /// </summary>
        ...
        /// <summary>
        /// A collection linking connection ID (Mirror) with SteamClient which contains CSteamID (Steam API)
        /// </summary>
