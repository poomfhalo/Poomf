...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:Standard,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:1,uamb:True,mssp:True,bkdf:True,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:2,rntp:3,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:0,x:33923,y:32537,varname:node_0,prsc:2|diff-1-RGB,emission-5749-OUT,amdfl-1628-OUT,clip-8287-OUT,voffset-1237-OUT;n:type:ShaderForge.SFN_Tex2d,id:1,x:33490,y:32289,ptovrint:False,ptlb:Diffuse,ptin:_Diffuse,varname:_Diffuse,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:66321cc856b03e245ac41ed8a53e0ecc,ntxv:3,isnm:False;n:type:ShaderForge.SFN_Multiply,id:1237,x:33730,y:33042,varname:node_1237,prsc:2|A-7769-RGB,B-8556-OUT;n:type:ShaderForge.SFN_ValueProperty,id:8578,x:33420,y:33303,ptovrint:False,ptlb:Amplitude,ptin:_Amplitude,varname:_Amplitude,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0.1;n:type:ShaderForge.SFN_ValueProperty,id:7411,x:32961,y:33208,ptovrint:False,ptlb:Wind speed,ptin:_Windspeed,varname:_Windspeed,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0.1;n:type:ShaderForge.SFN_Tex2d,id:7769,x:33485,y:33042,ptovrint:False,ptlb:,ptin:_,varname:_,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:28c7aad1372ff114b90d330f8a2dd938,ntxv:0,isnm:False|UVIN-4736-UVOUT;n:type:ShaderForge.SFN_Multiply,id:8287,x:33642,y:32881,varname:node_8287,prsc:2|A-1-A,B-660-OUT;n:type:ShaderForge.SFN_Slider,id:660,x:33277,y:32938,ptovrint:False,ptlb:Alpha_cutoff,ptin:_Alpha_cutoff,varname:_Alpha_cutoff,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_Slider,id:2005,x:32761,y:32520,ptovrint:False,ptlb:Rim_level,ptin:_Rim_level,varname:_Rim_level,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:3;n:type:ShaderForge.SFN_NormalVector,id:9820,x:32975,y:32333,prsc:2,pt:False;n:type:ShaderForge.SFN_Multiply,id:5749,x:33602,y:32508,varname:node_5749,prsc:2|A-5246-OUT,B-3199-OUT;n:type:ShaderForge.SFN_Fresnel,id:5246,x:33174,y:32390,varname:node_5246,prsc:2|NRM-9820-OUT;n:type:ShaderForge.SFN_Multiply,id:3199,x:33174,y:32531,varname:node_3199,prsc:2|A-2005-OUT,B-415-RGB;n:type:ShaderForge.SFN_Color,id:415,x:32839,y:32677,ptovrint:False,ptlb:Rim_color,ptin:_Rim_color,varname:_Rim_color,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5844507,c2:0.6205167,c3:0.6911765,c4:1;n:type:ShaderForge.SFN_FragmentPosition,id:2289,x:32888,y:32952,varname:node_2289,prsc:2;n:type:ShaderForge.SFN_ComponentMask,id:3348,x:33115,y:33019,varname:node_3348,prsc:2,cc1:0,cc2:1,cc3:2,cc4:-1|IN-2289-XYZ;n:type:ShaderForge.SFN_Time,id:7734,x:32961,y:33317,varname:node_7734,prsc:2;n:type:ShaderForge.SFN_Panner,id:4736,x:33316,y:33078,varname:node_4736,prsc:2,spu:1,spv:1|UVIN-3348-OUT,DIST-9275-OUT;n:type:ShaderForge.SFN_Multiply,id:9275,x:33160,y:33257,varname:node_9275,prsc:2|A-7411-OUT,B-7734-T;n:type:ShaderForge.SFN_Color,id:3806,x:33356,y:32597,ptovrint:False,ptlb:Ambient_color,ptin:_Ambient_color,varname:_Ambient_color,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.3496972,c2:0.5671161,c3:0.7205882,c4:1;n:type:ShaderForge.SFN_Multiply,id:1628,x:33642,y:32727,varname:node_1628,prsc:2|A-3806-RGB,B-4173-OUT;n:type:ShaderForge.SFN_Slider,id:4173,x:33277,y:32804,ptovrint:False,ptlb:Ambient_level,ptin:_Ambient_level,varname:_Ambient_level,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:2;n:type:ShaderForge.SFN_VertexColor,id:4768,x:33420,y:33423,varname:node_4768,prsc:2;n:type:ShaderForge.SFN_Multiply,id:8556,x:33703,y:33255,varname:node_8556,prsc:2|A-8578-OUT,B-4768-RGB;proporder:1-8578-7411-7769-660-2005-415-3806-4173;pass:END;sub:END;*/
...
Shader "Shader Forge/Animated foliage" {
    Properties {
        ...
        _Rim_level ("Rim_level", Range(0, 3)) = 1
        _Rim_color ("Rim_color", Color) = (0.5844507,0.6205167,0.6911765,1)
        _Ambient_color ("Ambient_color", Color) = (0.3496972,0.5671161,0.7205882,1)
        _Ambient_level ("Ambient_level", Range(0, 2)) = 1
